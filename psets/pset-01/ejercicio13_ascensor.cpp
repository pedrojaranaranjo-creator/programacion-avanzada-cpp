...
int main() {
    ...
    bool ok1 = a.setRangoPisos(-1, 20);
    std::cout << "Rango aceptado (-1 a 20): " << std::boolalpha << ok1 << std::endl;
    std::cout << "Minimo: " << a.getPisoMinimo() << std::endl;
    std::cout << "Maximo: " << a.getPisoMaximo() << std::endl;

    bool ok2 = a.setRangoPisos(30, 10);
    std::cout << "Rango aceptado (30 a 10): " << std::boolalpha << ok2 << std::endl;
    std::cout << "Minimo: " << a.getPisoMinimo() << std::endl;
    std::cout << "Maximo: " << a.getPisoMaximo() << std::endl;
